...
import org.mariotaku.twidereAntiBot.constant.SharedPreferenceConstants.KEY_EMOJI_SUPPORT
        ...
        private fun initResources(context: Context, packageName: String?) {
            ...
            try {
                ...
                if (info.metaData != null) {
                    this.useMipmap = info.metaData.getBoolean("org.mariotaku.twidereAntiBot.extension.emoji.mipmap")
                }
