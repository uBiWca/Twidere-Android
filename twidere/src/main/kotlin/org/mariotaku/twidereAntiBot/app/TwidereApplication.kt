...
package org.mariotaku.twidereAntiBot.app
...
import org.mariotaku.twidereAntiBot.activity.AssistLauncherActivity
import org.mariotaku.twidereAntiBot.activity.MainActivity
import org.mariotaku.twidereAntiBot.activity.MainHondaJOJOActivity
import org.mariotaku.twidereAntiBot.constant.*
import org.mariotaku.twidereAntiBot.extension.firstLanguage
import org.mariotaku.twidereAntiBot.extension.model.loadRemoteSettings
import org.mariotaku.twidereAntiBot.extension.model.save
import org.mariotaku.twidereAntiBot.extension.setLocale
import org.mariotaku.twidereAntiBot.model.DefaultFeatures
import org.mariotaku.twidereAntiBot.receiver.ConnectivityStateReceiver
import org.mariotaku.twidereAntiBot.service.StreamingService
import org.mariotaku.twidereAntiBot.util.*
import org.mariotaku.twidereAntiBot.util.concurrent.ConstantFuture
import org.mariotaku.twidereAntiBot.util.content.TwidereSQLiteOpenHelper
import org.mariotaku.twidereAntiBot.util.dagger.ApplicationModule
import org.mariotaku.twidereAntiBot.util.dagger.GeneralComponent
import org.mariotaku.twidereAntiBot.util.emoji.EmojioneTranslator
import org.mariotaku.twidereAntiBot.util.kovenant.startKovenant
import org.mariotaku.twidereAntiBot.util.kovenant.stopKovenant
import org.mariotaku.twidereAntiBot.util.media.MediaPreloader
import org.mariotaku.twidereAntiBot.util.media.ThumborWrapper
import org.mariotaku.twidereAntiBot.util.net.TwidereDns
import org.mariotaku.twidereAntiBot.util.notification.ContentNotificationManager
import org.mariotaku.twidereAntiBot.util.notification.NotificationChannelsManager
import org.mariotaku.twidereAntiBot.util.premium.ExtraFeaturesService
import org.mariotaku.twidereAntiBot.util.promotion.PromotionService
import org.mariotaku.twidereAntiBot.util.refresh.AutoRefreshController
import org.mariotaku.twidereAntiBot.util.sync.DataSyncProvider
import org.mariotaku.twidereAntiBot.util.sync.SyncController
import java.util.*
